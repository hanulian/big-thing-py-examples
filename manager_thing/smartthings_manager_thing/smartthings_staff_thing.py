...
class MXRobotVacuumSmartThingsStaffThing(MXSmartThingsStaffThing):
    def __init__(
        self,
        name: str,
        service_list: List[MXService],
    ...
    def is_on(self) -> bool:
        ...
        if ret:
            ...
            if on_state == 'on':
                ...
                MXLOG_DEBUG(f'unexpected devce state: {on_state}', 'red')
                return False
        else:
            return False
    ...
    def make_service_list(self):
        ...
        staff_value_list = [
            MXValue(
                name='is_on', func=self.is_on, tag_list=self._default_tag_list, type=MXType.BOOL, bound=(0, 2), cycle=10
            )
        ]
        staff_function_list = [
            MXFunction(
...
class MXTVSmartThingsStaffThing(MXSmartThingsStaffThing):
    def __init__(
        self,
        name: str,
        service_list: List[MXService],
...
class MXSmartTagSmartThingsStaffThing(MXSmartThingsStaffThing):
    def __init__(
        self,
        name: str,
        service_list: List[MXService],
...
class MXNonSmartThingsStaffThing(MXSmartThingsStaffThing):
    '''
...
class MXHubSmartThingsStaffThing(MXSmartThingsStaffThing):
    '''
    smartthings 허브 디바이스 (ex: SmartThings Station 등..)
    '''
