...
def arg_parse():
    ...
    parser.add_argument("--client_id", '-id', action='store', type=str,
                        required=False, default='', help="client id")
    parser.add_argument("--client_secret", '-secret', action='store', type=str,
                        required=False, default='', help="client secret")
