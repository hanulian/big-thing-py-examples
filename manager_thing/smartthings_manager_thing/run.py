...
def arg_parse():
    ...
    parser.add_argument(
        "--name", '-n', action='store', type=str, required=False, default='smartthings_manager_thing', help="thing name"
    )
    parser.add_argument(
    ...
    parser.add_argument("--client_id", '-id', action='store', type=str, required=False, default='', help="client id")
    parser.add_argument(
        "--client_secret", '-secret', action='store', type=str, required=False, default='', help="client secret"
    )
...
def generate_thing(args):
    thing = MXSmartThingsManagerThing(
        name=args.name,
        ip=args.host,
        port=args.port,
